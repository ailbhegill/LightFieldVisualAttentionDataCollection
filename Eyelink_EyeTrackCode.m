function Eyelink_EyeTrackCode(subjNo, useEL)
...
try
    ...
    if useEL
        ...
        a = clock;
        edfFile=['v' num2str(subjNo, '%02d') '_'...
    ...
    fid = fopen(['stimuliLists\randomVideoList_participant' num2str(subjNo, '%02d') '.txt'],'r');
    ...
    for indVid = 1:length(stimList)
        moviename = [pwd '\videos\' stimList{indVid}];
